...
# -------  INSERER VOTRE CODE ICI -----------------
  ...
  "postures": [
    ...
    {
        "nom": "La posture du cobra – Bhujangasana",
        "image": "https://www.ataraksy.com/wp-content/uploads/2019/02/Posture-du-cobra-en-yoga-ou-aussi-appel%C3%A9e-Bhujangasana-300x169.jpg",
        "description": "La posture du cobra débute en s’allongeant à plat ventre sur un tapis de yoga. Il faudra joindre les pieds et poser ses paumes de main sur le sol au niveau de ses épaules, tout en pointant ses doigts vers l’avant et en gardant ses coudes près du corps. Le front devra lui aussi être posé au sol. En inspirant, il faudra étirer le menton vers l’avant puis lever et faire basculer sa tête en arrière tout en ouvrant la poitrine et en poussant son torse vers l’avant. Concrètement, votre torse doit se soulever sans avoir à utiliser vos mains.",
        "instructions": "Allongez-vous à plat ventre sur un tapis de yoga. Joignez les pieds et posez vos paumes de main sur le sol au niveau de vos épaules, en pointant les doigts vers l’avant et en gardant les coudes près du corps. Posez votre front sur le sol. En inspirant, étirez le menton vers l’avant puis levez et faites basculer votre tête en arrière tout en ouvrant la poitrine et en poussant le torse vers l’avant. Soulevez votre torse sans utiliser vos mains.",
        "id": 6
    },
    {
